function [performanceTot, y] = rnnFunc(input, target)
    % %#codegen
    % Solve an Autoregression Problem with External Input with a NARX Neural Network
    % Script generated by Neural Time Series app
    % Created 09-May-2018 20:24:48
    %
    ...
    performanceTot = table(performance, trainPerformance, valPerformance, ...
                        testPerformance, closedLoopPerformance, stepAheadPerformance, ...
                        multiStepPerformance);
    % Deployment
    % Change the (false) values to (true) to enable the following code blocks.
    % See the help for each generation function for more information.
    funcName = 'rnn_created_Fnc';
    if (true)
