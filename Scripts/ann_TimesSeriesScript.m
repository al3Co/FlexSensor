...
if (false)
    ...
    % network performs.
    genFunction(net,'ann_TimeSeriesFunction');
    y = ann_TimeSeriesFunction(x,xi,ai);
end
if (true)
    % Generate a matrix-only MATLAB function for neural network code
    % generation with MATLAB Coder tools.
    genFunction(net,'ann_TimeSeriesFunction','MatrixOnly','yes');
    x1 = cell2mat(x(1,:));
    x2 = cell2mat(x(2,:));
    xi1 = cell2mat(xi(1,:));
    xi2 = cell2mat(xi(2,:));
    y = ann_TimeSeriesFunction(x1,x2,xi1,xi2);
end
if (false)
